                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>100</td>
                                            <td></td>
                                            <td style="width:  10%"><button class="btn btn-primary pull-left">View</button></td>
                                            <td style="width:  10%"><button class="btn btn-primary pull-left">Edit</button></td>
                                            <td style="width:  10%"><button class="btn btn-primary pull-left">Delete</button></td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            <td>2</td>
