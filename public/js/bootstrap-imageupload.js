...
(function($) {
    ...
    function getImageThumbnailHtml(src) {
        return '<img src="' + src + '" id="image_preview" onload="jcrop()" onblur="return checkCoords();" alt="Image preview" id="image_preview" onload="imagePreview()" class="thumbnail" style="max-height: ' + options.maxHeight + 'px; max-width: ' + options.maxWidth + 'px; min-height:100px; min-width:100px;">';
    }
    ...
    function submitImageFile($fileTab) {
        ...
        var $removeFileButton = $fileTab.find('.btn:eq(1)');
         var $cropAndSaveButton = $('#crop_and_save');
